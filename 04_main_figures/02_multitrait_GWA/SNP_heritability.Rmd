...
variance_components <- function(trait){
  ...
  cbind(
    trait = trait,
    component = c('h2_full', 'geno', 'h2_partial'),
    rbind(
...
write_csv(vexp, file = "04_main_figures/02_multitrait_GWA/pseudoheritabiliy.csv")
```

```{r plot-pseudoheritability}

# Create the plot for pseudoheritability

pd <- position_dodge(0.2)

pseudoheritability <- vexp %>% 
